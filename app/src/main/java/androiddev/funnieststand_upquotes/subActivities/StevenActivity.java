...
public class StevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Steven Wright");
        actionBar.setDisplayHomeAsUpEnabled(true);
        fab = (FloatingActionButton)findViewById(R.id.fab);; 
        viewPager = (ViewPager) findViewById(R.id.steven_viewPager);
        final CoordinatorLayout SteveQuoteScreen = (CoordinatorLayout)findViewById(R.id.shareStevenQuote);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(StevenActivity.this, "Starting Intent", Toast.LENGTH_SHORT).show();
                fab.setVisibility(View.GONE);
                SteveQuoteScreen.setBackgroundColor(getResources().getColor(R.color.colorBlack));
                Bitmap mBitmap = screenShot(SteveQuoteScreen);
                SteveQuoteScreen.setBackgroundColor(getResources().getColor(R.color.colorWhite));
    ...
    private void saveScreenShot(Bitmap bm){
        ...
        try{
            ...
            e.printStackTrace();
            Toast.makeText(StevenActivity.this, "App not Available", Toast.LENGTH_SHORT).show();
        }
